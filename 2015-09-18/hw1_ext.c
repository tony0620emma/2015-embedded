...
double compute_pi_avxsimd_v3(size_t dt)
{
	...
	for (int i = 0; i <= dt - 4; i += 4) {
		ymm3 = _mm256_add_pd(ymm3, ymm2);
		ymm4 = _mm256_fmadd_pd(ymm3, ymm3, ymm0);
		ymm4 = _mm256_div_pd(ymm1, ymm4);
		ymm5 = _mm256_add_pd(ymm4, ymm5);
	}
	double tmp[4] __attribute__((aligned(32)));
...
#elif defined(AVXSIMD3)
		compute_pi_avxsimd_v3(128000000);
#elif defined(BASE)
